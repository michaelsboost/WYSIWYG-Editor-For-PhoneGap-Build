$(document).ready(function() {
  ...
  if ( localStorage.getItem("inputCode")) {
    $(".input").val(localStorage.getItem("inputCode"));
  }
  if ( localStorage.getItem("outputCode")) {
    $(".output").val(localStorage.getItem("outputCode"));
  }
  ...
  $('.input').each(function(index, element) {
    ...
    .change(function() {
      ...
      localStorage.setItem("inputCode", this.value);
      localStorage.setItem("outputCode", this.value);
    })
    .focus(function() {
      if( typeof console != 'undefined' )
        ;//console.log( 'focus' );
